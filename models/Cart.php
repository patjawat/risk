...
class Cart extends Component
{
	...
	public function insert($items = [])
	{
		...
		{
			\Yii::t('app', 'The insert method must be passed an array containing data.');
			return FALSE;
		}
	...
	protected function _insert($items = array())
	{
		...
		{
			\Yii::t('app', 'Invalid product ID.  The product ID can only contain alpha-numeric characters, dashes, and underscores');
			return FALSE;
		}
		...
		{
			\Yii::t('app', 'An invalid name was submitted as the product name: '.$items['name'].' The name can only contain alpha-numeric characters, dashes, underscores, colons, and spaces');
			return FALSE;
		}
