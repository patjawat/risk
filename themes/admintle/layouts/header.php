...
.main-header {
 ...
 padding: 0px 0px 0px 0px;
    ...
    <?= Html::a('<span class="logo-mini">APP</span><span class="logo-lg ion-ios-medkit">โปรแกรมความเสี่ยง#</span>', Yii::$app->homeUrl.'?r=risk', ['class' => 'logo']) ?>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <!-- <img src="<?php  $directoryAsset ?>images/user-512.png" class="img-circle"alt="User Image"/> -->
                              <i class="fa fa-user-circle-o img-circle" aria-hidden="true"></i>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                              <?= Html::a('ขอมูลส่วนตัว', ['/profile/user/update', 'id' => Yii::$app->user->id],['class'=> 'btn btn-primary ion-android-contact']);?>
