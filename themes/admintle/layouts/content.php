              ...
              <?= dmstr\widgets\Menu::widget(
                  [
                      ...
                      'items' => [
                          ...
                          ['label' => 'เนื้อหา/บทความ', 'icon' => 'tags', 'url' => ['/content/blog']],
                          ['label' => 'ตั้งค่าผู้ใช้งาน', 'icon' => 'user', 'url' => ['/profile/user']],
                          ['label' => 'ตั้งค่าเนื้อหาของระบบ', 'icon' => 'tasks', 'url' => ['/risk-system']],
                          ['label' => 'แจ้งเตือน Line', 'icon' => 'globe', 'url' => ['/risk/line']],
                          [
