              ...
              <?= dmstr\widgets\Menu::widget(
                  [
                      ...
                      'items' => [
                          ...
                          [
                              'label' => 'ตั้งค่าระบบเครื่องมือแพทย์',
                              'icon' => 'glyphicon glyphicon-cog',
                              'url' => '#',
                              'items' => [
                                  ['label' => 'บริษัท/ห้างร้าน', 'icon' => 'ion-android-playstore', 'url' => ['/em/dealer'],],
                                  ['label' => 'หมวดหมู่', 'icon' => 'glyphicon glyphicon-th-list', 'url' => ['/em/category'],],
                                  ['label' => 'ยี่ห้อ', 'icon' => 'ion-ios-pricetags-outline', 'url' => ['/em/band'],],
                                  ['label' => 'วัสดุทางการแพทย์', 'icon' => 'glyphicon glyphicon-folder-open', 'url' => ['/em/product-items'],],
                                  ['label' => 'ทีมพัฒนา', 'icon' => 'ion-android-contacts', 'url' => ['/em/team/']],
